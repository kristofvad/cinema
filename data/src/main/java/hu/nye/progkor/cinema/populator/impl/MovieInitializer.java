...
public class MovieInitializer implements DBPopulator {
    ...
    private static final List<Movie> MOVIES = List.of(
            new Movie(1L, "Pulp Fiction", 1994, 154, MovieType.MOVIE_2D,
                    "The path of the righteous man is beset of all sides by the iniquities of the selfish and the tyranny of evil me"),
